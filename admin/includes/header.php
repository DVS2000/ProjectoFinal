    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion " style="background: #f0ad4e" id="meuSidebar">
      ...
      if ($user->getIdTipoUtilizador() == 11) {
        ...
        <li class="nav-item">
          ...
          <div id="collapseFaculdade" class="collapse" aria-labelledby="headingTwo" data-parent="#meuSidebar">
            <div class="bg-white py-2 collapse-inner rounded">         
              <a class="collapse-item" href="faculdade/">Novo</a>
              <a class="collapse-item" href="faculdade/vertodos.php">Ver Todos</a>
              <a class="collapse-item" href="faculdade/reciclagem.php">Desactivados</a>
            </div>
          </div>
        </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <button class="dropdown-item" onClick='<?php echo 'window.location.replace("http://localhost/inscricaoonline/admin/utilizador/editar.php?id=' . $user->getId() . '")'; ?>'>
