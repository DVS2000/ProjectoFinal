...
class SendEmail {
   ...
   public function resentPassowrd($emailSend, $nome, $newPassword) {
      ...
      $email = "projecto.uor@gmail.com";
      $password = "projectouor2021@";
      $smtp = "smtp.gmail.com";
 ...
 ', 'text/html');
    ...
    public function sendCustomEmail($emailSend, $nome, $body, $title) {
...
<html>
                                                         ...
                                                         <td align="center" bgcolor="#8BC34A" style="padding:20px 48px;color:#ffffff" class="banner-color">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%">
                                                                        <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">'.$title.'</h1>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;" class="title-color">Olá '.$nome.',</h3>
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">'.$body.'</p>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
 ...
 ', 'text/html');
    ...
    public function enviar($nome, $curso, $send) {
      ...
      $message = (new Swift_Message('BEM-VINDO A UNIVERSIDADE OSCAR RIBAS'))
        ...
        ->addPart('
         ...
         <body>
            ...
            <header>
               <img  style="width: 100px; height: 50px;" src="http://uor.ed.ao/wp-content/uploads/2017/03/uor_logo.png" alt="">
               <h3>UNIVERSIDADE OSCAR RIBAS</h3>
               <span>Avenida Samora Machel, Município de Talatona, Luanda-Angola</span> <br>
               <span>244922171521</span>
